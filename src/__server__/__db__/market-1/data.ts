...
export const mainCarouselData = [
  {
    title: "Rent Equipment, Earn Extra Income",
    imgUrl: "/assets/hero/skid-steer.webp",
    description: `Turn your idle tools into cash! List your equipment with us and let it pay for itself. No hassle, just profits.`,
    buttonText: "Start Earning",
    buttonLink: "/list-your-equipment",
  },
  {
    title: "Get 20% Off Your First Rental",
    imgUrl: "/assets/hero/rotter-hammer.jpg",
    description: `First-time renters save big! Discover top-quality tools and equipment at unbeatable prices.`,
    buttonText: "Browse Rentals",
    buttonLink: "/rent-now",
  },
  {
    title: "Flexible Rental Plans for Every Job",
    imgUrl: "/assets/hero/CAT38.jpg",
    description: `From hourly to monthly rentals, our flexible plans fit your project needs perfectly. Rent smarter with us!`,
    buttonText: "Explore Plans",
    buttonLink: "/pricing",
  },
  {
    title: "Premium Equipment, Zero Maintenance Costs",
    imgUrl: "/assets/hero/featured-equipment-rentals.jpg",
    description: `Why buy when you can rent? Access top-tier equipment without the hassle of ownership or maintenance.`,
    buttonText: "Rent Now",
